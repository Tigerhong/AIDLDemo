...
public class AppleService extends Service {
    ...
    AppleChangeListener onAppleChangeListener;
...
//                            listTemp.add(apple);
    ...
    IAppleService.Stub mIBinder = new IAppleService.Stub() {
        ...
        @Override
        public void regisertAppleChangeListener(AppleChangeListener listener) throws RemoteException {
            Log.i("AppleService", "regisertAppleChangeListener: "+listener.toString());
            onAppleChangeListener = listener;
        }

        @Override
        public void unRegisertAppleChangeListener() throws RemoteException {
